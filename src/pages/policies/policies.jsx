            ...
            <div className="faq__main">
                ...
                <div className="faq__main--text">
                    <div className="term_cont">
                        ...
                        <p className="textSpacing"> Please read the following rules carefully before signing in.</p>

                        <p className="textSpacing">
                        ...
                        <p className="textSpacing"> We are not FDIC insured. We are not a licensed bank or a security firm.</p>
                        ...
                        <p className="textSpacing">If you do not agree with the above disclaimer, please do not go any further.</p>
                    ...
                    All the data given by a User to CJ GRAND EXCHANGE will be only privately used and not disclosed to any third parties. The information
